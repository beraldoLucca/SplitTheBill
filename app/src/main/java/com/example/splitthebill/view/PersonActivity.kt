...
class PersonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getBooleanExtra("VIEW_PERSON", false)){
            ...
            apb.descriptionEt.isEnabled = false
        ...
        receivedPerson?.let { person ->
            ...
            apb.valorPagoEt.setText(person.paidValue.toString())
            apb.descriptionEt.setText(person.description)
        }
        ...
        apb.saveBt.setOnClickListener {
            if (
                ...
                val person = Person(
                    ...
                    paidValue = apb.valorPagoEt.text.toString().toDouble(),
                    valueToPay = null,
                    valueToReceive = null,
                    description = apb.descriptionEt.text.toString(),
                )
                setResult(
                    RESULT_OK,
                    Intent().putExtra(
                ...
                Toast.makeText(
                    this, getString(R.string.ensuring_inputs_person_activity), Toast.LENGTH_LONG
                ).show()
            }
        }
    }
